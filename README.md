...
Its novelty is therefore best understood as the security-focused productization and hardening of this pattern for real-world legacy applications, rather than the first use of Trusted Types, DOMPurify, or default-policy sanitization.
